...
class LaunchRequestHandler(AbstractRequestHandler):
 ...
 # AddNewPatient Intent Handler       
class AddNewPatientIntentHandler(AbstractRequestHandler): #Insert Name of Patient
    
    def can_handle(self, handler_input):
        return ask_utils.is_intent_name("AddNewPatientIntent")(handler_input)
...
class SpecifyPatientNameIntentHandler(AbstractRequestHandler):
    def can_handle(self, handler_input):
        return ask_utils.is_intent_name("SpecifyPatientNameIntent")(handler_input)
        #return handler_input.request_envelope.request.type == "IntentRequest" and handler_input.request_envelope.request.intent.name == "SpecifyPatientNameIntent"
...
class SpecifyPatientBirthdayIntentHandler(AbstractRequestHandler):
    def can_handle(self, handler_input):
        return handler_input.request_envelope.request.type == "IntentRequest" and handler_input.request_envelope.request.intent.name == "SpecifyPatientBirthdayIntent"
