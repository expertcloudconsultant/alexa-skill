...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome to Appointments. Here is where you see all scheduled appointments. Which patient are you after?"
        reprompt = "I do not know that one. What other patient's appointment do you want to see?"
...
database = client["appointmentsdb"]
appointments_collection = database["patientschedule"]
...
sb.add_request_handler(BookAppointmentIntentHandler())
